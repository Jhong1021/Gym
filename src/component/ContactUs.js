...
const ContactUs = () => {
    return (
        <div id="contact" className="sm:p-10 my-auto">
                ...
                <div className="grid grid-cols-4 text-gray-800 lg:grid-cols-3">
                        ...
                        <ul>
                            ...
                            <li className="my-6 flex items-center text-left">
                                ...
                                <div>
                                    <a
                                        className="cursor-pointer font-serif text-base md:text-lg"
                                        href="https://twitter.com/abrahama_real"
                                    >
                                        strengthstation@gmail
                                    </a>
                            ...
                            <li className="my-6 flex items-center text-left">
                                ...
                                <div>
                                    <p className="font-serif text-base md:text-lg">strengthstation@gmail</p>
                    ...
                    <div className="order-first col-span-4 max-w-screen-md px-8 py-10 md:order-last md:col-span-2 md:px-10 md:py-12">
                        ...
                        <form action="">
                            ...
                            <button
                                type="submit"
                                className="group flex cursor-pointer items-center rounded-xl bg-[#FCCB06] px-8 py-4 text-center font-semibold leading-tight text-white"
                            >
                                Send
                                <svg
